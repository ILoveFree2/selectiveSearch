function [ conbineResult, height,width ] = selectiveSearchWithrgb( imageName, theK, para_size, para_fill, para_color,para_texture )
...
%change the image to normalized rgb color map
colourIm = RGB2rgb(im);
