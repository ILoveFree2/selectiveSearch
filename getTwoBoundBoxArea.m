function [ boundingBoxArea ] = getTwoBoundBoxArea( box1,box2 )
...
% box1: the input bounding box1
% box2: the input bounding box2
% boundingBoxArea : the total area of the merged bounding box, they are NOT
% accually merged, we just get the area
upperleftX =  min(box1(1),box2(1));
lowerRightX = max(box1(3),box2(3));
upperleftY =  min(box1(2),box2(2));
lowerrightY = max(box1(4),box2(4));

boundingBoxArea = (lowerRightX - upperleftX + 1)*(lowerrightY -  upperleftY + 1);
